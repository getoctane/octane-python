...
import octane
from octane import api_requestor, util, six
...
class OctaneObject(dict):
    ...
    def __init__(
        ...
        **params
        ...
        super(OctaneObject, self).__init__()
    ...
    def update(self, update_dict):
        ...
        return super(OctaneObject, self).update(update_dict)

    def __setattr__(self, k, v):
        if k[0] == "_" or k in self.__dict__:
            return super(OctaneObject, self).__setattr__(k, v)
    ...
    def __delattr__(self, k):
        if k[0] == "_" or k in self.__dict__:
            return super(OctaneObject, self).__delattr__(k)
        else:
            del self[k]
    ...
    def __setitem__(self, k, v):
        ...
        super(OctaneObject, self).__setitem__(k, v)

    def __getitem__(self, k):
        try:
            return super(OctaneObject, self).__getitem__(k)
        except KeyError as err:
            if k in self._transient_values:
                raise KeyError(
                    "%r.  HINT: The %r attribute was set in the past."
                    "It was then wiped when refreshing the object with "
                    "the result returned by Octane's API, probably as a "
    ...
    def __delitem__(self, k):
        super(OctaneObject, self).__delitem__(k)
    ...
    def request(self, method, url, params=None, headers=None):
        ...
        requestor = api_requestor.APIRequestor(
            ...
            api_version=self.octane_version,
        )
        response, api_key = requestor.request(method, url, params, headers)

        return util.convert_to_octane_object(
            response, api_key, self.octane_version
        )
