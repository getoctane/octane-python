...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(octane.api_requestor._api_encode(params))

        for key, value in octane.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = octane.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, octane.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, octane.six.text_type):
